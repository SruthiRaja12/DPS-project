...
def home(request):
    ...
    encrypted_dataset_path = "C:/Users/yazhini/OneDrive/Pictures/DATA PRIVACY AND SECURITY LAB/CAT 1 PROJECT/encrypted_dataset.csv"
    ...
    if request.method == 'POST':
        ...
        # Load the model
        clf = load("C:/Users/yazhini/OneDrive/Pictures/DATA PRIVACY AND SECURITY LAB/CAT 1 PROJECT/clf.joblib")
